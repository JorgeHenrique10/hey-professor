...
it('should be able an validate if question exists', function () {
    $user = User::factory()->create();
    ...
    $request = post(route('question.store', ['question' => 'Alguma pergunta?']));

    $request->assertSessionHasErrors(['question' => 'Pergunta já existe!']);
});
